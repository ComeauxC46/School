...
DoublyLinkedList::DoublyLinkedList(const DoublyLinkedList& dll)
{
  ...
  // Copy from dll
  //copy first node
  DListNode* newNode = dll.getFirst(); //newNode points to a node in dll
  header.next = trailer.prev = new DListNode(newNode->getElem(), &header, &trailer); // copy the first node
